    ...
    <div className="px-3 py-16">
      <div className="max-w-md mx-auto bg-white p-3 rounded">
        <div className="px-3 ">
          ...
          <button
            className="h-12 w-full hover:bg-slate-200 focus:outline-none bg-white border-black border-2 rounded text-black mb-3
           ...
           <GoogleLogin 
                width={380}
                  onSuccess={credentialResponse => {
                    ...
                    axios.post("http://localhost:4001/user/email_login",{Enteredemail},{withCredentials:true})
                    .then((res) => {
          ...
          <div className="mt-3">
            ...
            <div className="relative py-4 flex justify-center">
              <span className="absolute px-4 rounded -top-4 left-30 bg-white">
                Or{" "}
              </span>
            </div>
          </div>
          <form onSubmit={handleSubmit}>
            <div className="relative mb-3">
              <span className="ml-2 bg-white px-2 absolute -top-3 text-sm">
                Email
              </span>
              <input
                type="email"
